...
#pragma warning restore CS0649
    ...
    readonly string SonarProjectKey = "tamp-build_tamp-adjacent-container-provisioning";
    ...
    Target Test => _ => _
        ...
        .Description("Unit tests — Tamp.AdjacentContainer.Provisioning has no integration tests (PAT-gated; consumers run their own E2E in their own pipeline).")
        .Executes(() => DotNet.Test(s => s
            .SetProject(RootDirectory / "tests" / "Tamp.AdjacentContainer.Provisioning.Tests" / "Tamp.AdjacentContainer.Provisioning.Tests.csproj")
            .SetConfiguration(Configuration)
            .SetNoBuild(true)
    ...
    Target Pack => _ => _
        ...
        {
            s.SetProject(RootDirectory / "src" / "Tamp.AdjacentContainer.Provisioning" / "Tamp.AdjacentContainer.Provisioning.csproj");
